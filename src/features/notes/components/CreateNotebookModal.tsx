...
import {
  createNotebookFormSchema,
  CreateNotebookFormSchema,
} from "../forms/create-notebook";
import { api } from "~/utils/api";
import { toast } from "sonner";
import { X } from "lucide-react";
import { Form } from "~/components/ui/form";
import { CreateNotebookFormInner } from "./CreateNotebookFormInner";
...
export const CreateNotebookModal = ({
  ...
  const handleCreateNotebook = (data: CreateNotebookFormSchema) => {
